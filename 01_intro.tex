...
\begin{frame}{Schedule}
    \begin{enumerate}
        ...
        \item Latplan        
        \item[4--7.5] Presentations of the recent advancements in the area
    \end{enumerate}
\end{frame}

\begin{frame}{Presentations}
    \begin{itemize}
        \item 18-minute talk about a paper published in the last two years (2024, 2025, 2026);
        \item containing neurosymbolic component
        \item you must get my approval for it \alert{before the talk}
        \item optionally: a team of $n\in\{1,2,3,4,5\}$ students presenting a single paper during a slot of $18n$ minutes        
    \end{itemize}
\end{frame}
...
\begin{frame}{Timeline for the project}
    \begin{description}
        \item[04 -- 18.03] discussion phase;
        \item[18.03] project proposal submitted;
        \item[25.03 -- 15.04] first checkpoint;
        \item[22.04 -- 06.05] second checkpoint; 
        \item[13.05 -- 27.05] third checkpoint;
        \item[01.06/08.06] project report submitted;
        \item[03.06/10.06] project defense.
    \end{description}
\end{frame}
...
\begin{frame}{Gartner -- Hype Cycle for Artificial Intelligence, 2025}
	\centering\includegraphics[width=.9\textwidth]{et-hc-2025-press-release.jpg}
	\source{\url{https://www.gartner.com/en/newsroom/press-releases/2025-08-05-gartner-hype-cycle-identifies-top-ai-innovations-in-2025}}
\end{frame}
...
\begin{frame}{Neuro-symbolic journal}
	\begin{minipage}{.49\textwidth}
		\includegraphics[width=\textwidth]{default_cover.jpg}
	\end{minipage}
	\begin{minipage}{.49\textwidth}
		\emph{Neurosymbolic Artificial Intelligence} is an open access and transparently peer-reviewed research journal covering a wide range of topics related to neurosymbolic AI.
		\vspace{1cm}
...
\begin{frame}{Neuro-symbolic conferences and workshops}
    \begin{itemize}
	    \item NeSy \url{https://www.nesy-ai.org/}
        \begin{description}
            \item[2005--2022] an annual workshop affiliated with a major AI conference;
            \item[2023--] an annual conference of its own
        \end{description}             
	\item International Conference on Neuro-Symbolic Systems (NeuS)\\
		\url{https://sites.google.com/usc.edu/neus2026/home}
	\item 12th International Summer School on AI and Big Data\\
		theme: Neuro+Symbolic AI
	\item 1st International Workshop on Advanced Neuro-Symbolic Applications\\
		\url{https://ansya-workshop.github.io/2025/} (ECAI 2025)
	\item many others, just type in \emph{neurosymbolic workshop 2026} into a search engine
    \end{itemize}
\end{frame}
